...
CREATE TABLE `class_schedule`  (
  `t_id` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `t_faculty` smallint(6) NOT NULL,
  `t_specialty` smallint(6) NOT NULL,
  `t_class` tinyint(4) NOT NULL,
  `t_grade` smallint(6) NOT NULL,
  `t_school_year` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `t_semester` tinyint(4) NOT NULL,
  `t_content` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `hitokoto`  (
  ...
  `h_content` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `h_type` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `h_from` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `h_from_who` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `h_creator` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `news`  (
  ...
  `n_summary` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `n_images` varchar(2048) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `n_create_time` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
...
CREATE TABLE `news_chart`  (
  `n_type_id` int(11) NOT NULL,
  `n_name` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `news_headline`  (
  ...
  `h_image` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `sign_keys`  (
  `app_key` tinytext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `app_secret` tinytext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `platform` tinytext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `mail` tinytext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `student_achieve`  (
  ...
  `a_school_year` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `a_semester` tinyint(4) NOT NULL,
  `a_content` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
